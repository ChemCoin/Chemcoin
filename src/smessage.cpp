// Copyright (c) 2014 The Chemcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("chemcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("chemcoin-smsg-pow"); // Make this thread recognisable
